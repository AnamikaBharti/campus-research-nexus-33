        ...
        {/* <div className="row">
          <div className="col-12">
            <div className="bg-gradient text-white rounded p-5 text-center" 
              ...
              <h3 className="mb-3">Ready to Launch Your Startup?</h3>
              <p className="mb-4">
                Transform your innovative idea into a successful business with our comprehensive support
              </p>
              <div className="d-flex gap-3 justify-content-center flex-wrap">
                <button className="btn btn-light btn-lg">Apply for Incubation</button>
                <button className="btn btn-outline-light btn-lg">Schedule Meeting</button>
              </div>
            </div>
          </div>
        </div> */}
